 ...
 * app_reset.cpp
 *
 * Factory reset implementation for Matter SCD40 Air Quality Sensor with OLED
 *
 * Simple GPIO-based implementation without iot_button library dependency
 */
...
// GPIO for reset button (uses BOOT button on XIAO ESP32C6)
